...
#define FOX_SPEED 3
#define FOX_JUMP_SPEED 100
// define map
#define GROUND Globals::screenHeight - 110
...
#define KEY_BACK			1
#define KEY_LEFT			1<<1 //2
#define KEY_RIGHT			1<<2 //4
#define KEY_UP				1<<3 //8
#define KEY_DOWN			1<<4
...
#define KEY_SPACE			1<<9
#define KEY_SHOT			1<<10
#define KEY_SCRATCH			1<<11
#endif
